...
public class InsolacaoTerrestreActivity extends Activity {
    ...
    private void saida(int d, String m, int a, double hi, double ha, double hp, String sUTC) {	
	    ...
	    editText13.setText(String.valueOf("INSOLAÇÃO TERRESTRE EM " + String.valueOf(d)+ " DE " + m.toUpperCase()+" DE "+String.valueOf(a)+":"));
	    editText14.setText(String.valueOf("Duração prevista de " + timeToStr(hi) + " " + sUTC + " UTC;"));
